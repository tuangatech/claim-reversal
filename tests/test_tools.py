...
class TestTriageDenial:
    def test_clinical_proceed(self):
        ...
        r = triage_denial("CLM-2024-00123", "CO-50", 12400.0, "HUMANA", date_of_service, denial_date)
    ...
    def test_administrative(self):
        ...
        denial_date = (date.today() - timedelta(days=5)).isoformat()
        r = triage_denial("CLM-2024-00123", "CO-4", 5000.0, "HUMANA", "2026-05-01", denial_date)
    ...
    def test_deadline_closed(self):
        ...
        r = triage_denial("CLM-2024-00123", "CO-50", 12400.0, "AETNA", "2026-01-01", denial_date)
    ...
    def test_low_worthiness(self):
        ...
        denial_date = (date.today() - timedelta(days=5)).isoformat()
        r = triage_denial("CLM-2024-00123", "CO-50", 200.0, "HUMANA", "2026-05-01", denial_date)
    ...
    def test_unknown_code(self):
        ...
        denial_date = (date.today() - timedelta(days=5)).isoformat()
        r = triage_denial("CLM-2024-00123", "CO-9999", 5000.0, "HUMANA", "2026-05-01", denial_date)
    ...
    def test_co57_is_clinical(self):
        ...
        denial_date = (date.today() - timedelta(days=5)).isoformat()
        r = triage_denial("CLM-2024-00123", "CO-57", 5000.0, "HUMANA", "2026-05-01", denial_date)
...
class TestFetchPatientRecords:
    def test_sufficient_records(self):
        ...
        records = fetch_patient_records("CLM-2024-00123", "2026-05-01")
    ...
    def test_sparse_records(self):
        ...
        records = fetch_patient_records("CLM-2024-00199", "2026-04-15", include_supplemental=False)
    ...
    def test_supplemental_records(self):
        ...
        records = fetch_patient_records("CLM-2024-00199", "2026-04-15", include_supplemental=True)
...
class TestAuditLog:
    def test_log_event(self):
        ...
        r = log_appeal_event("CLM-2024-00123", "test_event", {"key": "value"}, "test_agent")
        ...
        assert row["claim_id"] == "CLM-2024-00123"
...
class TestClaimHistory:
    def test_found(self):
        ...
        r = get_claim_history("CLM-2024-00123")

        assert r["status"] != "not_found"
        assert r["claim_id"] == "CLM-2024-00123"
...
class TestPhysicianReview:
    def test_required_high_value_bcbs(self):
        ...
        r = physician_review("CLM-2024-00123", "clinical", 15000.0, "BCBS", "test letter")
    ...
    def test_not_required(self):
        ...
        r = physician_review("CLM-2024-00123", "clinical", 800.0, "AETNA", "test letter")
    ...
    def test_administrative_not_required(self):
        ...
        r = physician_review("CLM-2024-00123", "administrative", 50000.0, "BCBS", "test letter")
...
class TestSubmitAppeal:
    def test_submit(self):
        ...
        r = submit_appeal("CLM-2024-00123", "HUMANA", "test letter text")
